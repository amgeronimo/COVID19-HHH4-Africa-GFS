                          ...
                          sidebarLayout(             #creates sidebar of inputs and countries
                            sidebarPanel(
                              ...
                              selectInput("countries",
                                          ...
                                          selected = "Algeria",
                                          multiple = TRUE), 
                              h4(HTML(paste("This is a replication of the paper",
                                            tags$a(href="https://www.pnas.org/content/118/28/e2026664118", 
                                                       ...
                                                       "(Ssentongo et al., 2021) in which the weather data from the UK MET",
                                                       "service for rainfall, temperature, and humidity has been replaced by",
                                            tags$a(href="https://rda.ucar.edu/datasets/ds084.1/#!",
                                                   "GFS resources."))))
                            ),
