...
# Weather
weather_clean <- readr::read_csv("data/original/africa_weather_weighted_gfs.csv")
...
# Weather data 
rain_mean <- extrac_var_climate(var = "A_PCP_L1_Accum_1_mean", data = weather_clean)
temp_mean <- extrac_var_climate(var = "TMP_L103_mean", data = weather_clean)
sh_mean <- extrac_var_climate(var = "SPF_H_L103_mean", data = weather_clean) 
